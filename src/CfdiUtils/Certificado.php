...
class Certificado
{
    ...
    /**
     * This property does not have a getter, is used in belongsTo to check if the certificate match a private key
     * @var string
     */
    private $contents;
    ...
    public function __construct(string $filename)
    {
        ...
        // change to PEM format if is not
        if (false === strpos($contents, '-----BEGIN CERTIFICATE-----')) {
    ...
    public function belongsTo(string $pemKeyFile, string $passPhrase = ''): bool
    {
        ...
        $belongs = openssl_x509_check_private_key($this->contents, $privateKey);
