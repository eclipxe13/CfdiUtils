# Validadores estándar para CFDI 3.3
...
Obtiene las sumas de los importes de los conceptos y las sumas agrupadas de los impuestos
y las valida contra la información del comprobante y el nodo principal de impuestos.
...
Es posible que un emisor intente modificar el comprobante, simplemente altera el contenido
